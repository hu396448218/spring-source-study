...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
		...
		synchronized (this.startupShutdownMonitor) {
			...
			* */
			...
			try {
				...
				/**
				 * 把实现 BeanPostProcessors 接口实例化，并加入到 BeanFactory 中
				 *
				 * */
				...
				/**
				 * 这个方法，着重理解模板设计模式，因为springboot中，这个方法，是用来做内嵌tomcat启动的
				 */
				//空方法-钩子方法,tomcat 就是这样嵌入进来的
	...
	protected ConfigurableListableBeanFactory obtainFreshBeanFactory() {
		//核心方法： ---重点重点5星
		//refreshBeanFactory()
		// 设计模式：模板设计模式 --称为钩子方法 调用到 : AbstractRefreshableApplicationContext orGenericApplicationContext
		refreshBeanFactory();
		return getBeanFactory();
	}
